  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
          ...
          {filteredDresses.map((dress, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-4 left-4 right-4 flex justify-between">
                    <motion.button
                      className="bg-perfect-pink text-white p-3 rounded-full shadow-lg"
              ...
              <div className="p-6">
                ...
                <p className="text-2xl font-bold text-perfect-pink">{dress.price}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <motion.button
            className="bg-perfect-pink text-white px-8 py-4 text-lg font-medium uppercase tracking-wider rounded-full shadow-xl"
            whileHover={{ 
              scale: 1.05,

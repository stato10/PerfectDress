        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-white bg-opacity-90 text-gray-800 placeholder-gray-500 border border-gray-200 focus:outline-none focus:border-perfect-pink focus:ring-2 focus:ring-perfect-pink focus:ring-opacity-50 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="6"
                    className="w-full px-4 py-3 rounded-lg bg-white bg-opacity-90 text-gray-800 placeholder-gray-500 border border-gray-200 focus:outline-none focus:border-perfect-pink focus:ring-2 focus:ring-perfect-pink focus:ring-opacity-50 transition-colors resize-none"
                ...
                <motion.button
                  type="submit"
                  className="w-full bg-perfect-pink text-white py-4 rounded-lg font-medium text-lg shadow-lg"
                  whileHover={{ 
                    scale: 1.02,
          ...
          >
            ...
            {contactInfo.map((item, index) => (
              <motion.div
                key={item.title}
                className="bg-white bg-opacity-95 rounded-2xl p-6 shadow-xl border border-white border-opacity-30 backdrop-blur-sm"
              ...
              >
                <a href={item.link} className="flex items-center space-x-4 group">
                  <div className="bg-perfect-pink text-white p-3 rounded-full group-hover:scale-110 transition-transform shadow-lg">
            ...
            >
              <h3 className="text-gray-800 font-semibold text-lg mb-4">Follow Us</h3>
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.url}
                    className="bg-perfect-pink text-white p-3 rounded-full hover:scale-110 transition-transform shadow-lg"
          ...
          <div className="bg-white bg-opacity-95 rounded-3xl p-8 shadow-xl border border-white border-opacity-30 backdrop-blur-sm">
            ...
            <div className="aspect-video bg-gray-100 rounded-2xl flex items-center justify-center border-2 border-dashed border-gray-300">
              <div className="text-center">
                <FaMapMarkerAlt className="text-6xl text-perfect-pink mx-auto mb-4" />

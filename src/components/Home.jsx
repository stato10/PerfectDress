...
const Home = () => {
  ...
  if (isMobile) {
    // Mobile version with no animations for maximum performance
    return (
      <section 
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="text-white">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold uppercase leading-tight mb-4 sm:mb-6 lg:mb-8">
              Perfect Dress
            </h1>
            
            <p className="text-lg sm:text-xl md:text-2xl font-light mb-6 sm:mb-8 lg:mb-10 max-w-2xl mx-auto px-4">
        ...
        {/* Social Media Icons */}
        <div className="absolute bottom-4 sm:bottom-6 lg:bottom-8 left-0 right-0 z-10 flex justify-center items-center space-x-4 sm:space-x-6 lg:space-x-8">
